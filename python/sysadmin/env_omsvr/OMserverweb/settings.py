...
ADMINS = (
    ('cyril', 'cyril@gmail.com'), 
)
INTERNAL_IPS = ('127.0.0.1','192.168.18.131',)
...
STATICFILES_DIRS = (
    ...
    '/devops/env_omsvr/OMserverweb/static/',
)
...
TEMPLATE_DIRS = (
    ...
    '/devops/env_omsvr/OMserverweb/templates',
    '/devops/env_omsvr/lib/python2.7/site-packages/debug_toolbar/templates',
    BASE_DIR+'/templates'
)
