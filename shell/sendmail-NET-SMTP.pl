...
#smtp邮件服务器和端口
my $smtpHost = 'mail.aa.net';
my $smtpPort = '25';
#my $sslPort = '465';
 
#smtp服务器认证用户名密码(就是你登陆邮箱的时候的用户名和密码)
my $username = 'monitor@aa.net';
my $passowrd = 'xxx2';
 
#邮件来自哪儿，要去哪儿,邮件标题
my $from = 'monitor@aa.net';
my $to   = 'aa@aa.net';
my $subject = '[Notice mha]测试邮件';
...
# 有BUG 改功能无法正常识别SSL 版本号，STARTTLS 请使用Net::SSLGlue::SMTP 模块
use Net::SMTP::TLS;
